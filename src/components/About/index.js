        ...
        <section>
            ...
            <div className="about-container">
                ...
                <p>
                    ...
                    I strive to create beautiful, functional and quality web experiences for the users.
                    <br /> <br />
                    When I am not coding, I enjoy knitting (anything from intricate sweaters to small trinkets),
                    traveling, cooking, and going for long hikes.
                    <br /> <br />
                    Web development is exciting to me because it brings new challenges everyday. I love being able to
